...
<input class="form-control" placeholder="Username Anda" name="username" type="text" autofocus>
</div>
</div>
<div class="form-group">
<div class="input-group">
...
<input class="form-control" placeholder="Password Anda" name="password" type="password" autofocus>
</div>
</div>
<div class="form-group">
